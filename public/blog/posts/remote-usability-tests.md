This week, we set up remote, unmoderated usability tests with Loop11. It was a bit of a train wreck—but probably an excellent primer for conducting quick usability tests in the real world, so to speak.
